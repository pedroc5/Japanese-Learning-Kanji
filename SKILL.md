...
`/tmp/kanji_content.json` に次の形式で書く。**例文の中の対象漢字は `<b>` で囲む**（JSONの中でHTMLタグを使ってよいのは `examples` と `quiz.q` だけ）。
  ...
  "kanji": [
    {
      ...
      "examples": [
        "京都に<b>二泊三日</b>で旅行しました。",
        "友だちを一晩家に<b>泊</b>めてあげた。"
      ]
    }
  ],
  "quiz": [
    {
      "q": "このホテルの<b>宿泊</b>料金は一人八千円です。",
      "a": "しゅくはく",
      "alt": ["しゅくばく"],
